...
app.get('/addbook',isAdmin,(req,res,next)=>{
  const errorMessage = req.query.error;
...
app.get('/deleteuser/:user_id',isAdmin, (req, res) => {
...
app.get('/deletebook/:book_id',isAdmin, (req, res) => {
...
app.get('/updateuser/:user_id', isAdmin, (req, res) => {
...
app.get('/updatebook/:book_id', isAdmin, (req, res) => {
  const book_id = req.params.book_id;
...
app.get('/confirm/:book_id', isUser, (req, res, next) => {
...
app.get('/managebook',isAdmin,(req, res) => {
...
app.get('/foruser',isUser,(req, res) => {
  const sql = 'SELECT * FROM books';
  connection.query(sql,(err, results)=>{
    if(err) throw err;
...
app.get('/record',isAdmin,(req, res) => {
...
app.get('/category',isUser,(req,res)=>{
  res.render('books/category',{class:'category'})
});
app.get('/category/reference_book',isUser,(req,res,next)=>{
...
app.get('/category/textbook',isUser,(req,res)=>{
...
app.get('/category/fiction',isUser,(req,res)=>{
...
app.get('/category/non_fiction',isUser,(req,res)=>{
...
app.get('/category/science_and_technology',isUser,(req,res)=>{
...
app.get('/category/periosicals_and_journals',isUser,(req,res)=>{
...
app.get('/issued_book',isUser,(req,res)=>{
  const username = req.session.username;
...
app.post('/updateuser/:user_id', isAdmin, (req, res) => {
  const userId = req.params.user_id;
...
app.post('/updatebook/:book_id', isAdmin, (req, res) => {
  const book_id = req.params.book_id;
...
app.post('/search_book_admin', (req, res) => {
...
app.post('/search_book_user', (req, res) => {
  const searchBook = req.body.searchBook;
  const sql = "SELECT * FROM books WHERE title LIKE ?";
  const query = connection.query(sql, [`%${searchBook}%`], (err, results) => {
    if (err) throw err;
